...
在简介中， 我说了你可以对表格中的数据进行以下操作： 创建，读取，更新，删除 ( "Create Read Update Delete" )。 不过一开始你应该如何创建表格呢？ 你需要在数据库 database \emph{schema} 执行 CRUD。 并且，你学到的第一条SQL命令，是创建命令， \ident{CREATE}:
